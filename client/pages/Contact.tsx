    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Have questions about FinanceBot? We'd love to hear from you. 
      ...
      <Card className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border-emerald-200 dark:border-emerald-800">
        <CardHeader>
          ...
          <CardDescription>
            For general inquiries, feature requests, or support, reach out to our team
          </CardDescription>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <a href="mailto:team@financebot.com">
                ...
                <span className="text-sm text-gray-500">team@financebot.com</span>
              </a>
            </Button>
            ...
            >
              <a href="mailto:bugs@financebot.com">
                ...
                <span className="text-sm text-gray-500">bugs@financebot.com</span>
              </a>
            </Button>
            ...
            >
              <a href="mailto:features@financebot.com">
                ...
                <span className="text-sm text-gray-500">features@financebot.com</span>
              </a>
            </Button>
          </div>
        </CardContent>
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center">Meet Our Team</h2>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Yes, we use industry-standard encryption to protect your data. Your financial information 
                is stored securely and is never shared with third parties.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Absolutely! FinanceBot supports family mode where you can combine incomes and track 
                shared expenses with family members.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Our AI assistant analyzes your financial data to provide personalized advice, 
                answer questions, and help you make better financial decisions.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Currently, FinanceBot is a responsive web application that works great on mobile devices. 
